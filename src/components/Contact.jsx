...
const Contact = () => {
  return (
    <div
      id="contact"
      className="scroll-mt-24 font-man flex flex-col lg:flex-row p-5 sm:p-8 lg:p-10 bg-darkBlue gap-10"
    >
      {/* left */}
      <div className="flex flex-col gap-4 w-full lg:w-1/2 p-2 sm:p-5 lg:p-9">
        <h1 className="uppercase text-sm sm:text-base lg:text-lg font-bold text-lightBrown">
          Get in touch
        </h1>

        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-beige">
          Let’s Discuss Your <br /> Goals
        </h2>

        <p className="font-medium text-sm sm:text-base lg:text-lg tracking-wide sm:tracking-widest text-white">
